...
urlpatterns = [
    ...
    path('user-agreement/', TemplateView.as_view(template_name="frontend/user_agreement.html")),
    path('personal_data/', TemplateView.as_view(template_name="frontend/personal_data.html")),
]
